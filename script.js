...
class Workout {
  ...
  constructor(coords, distance, duration) {
    ...
    // this.date=new Date(); the above declared method is not perfectly implimented in es6
  }
  _setDescription() {
    // prettier-ignore
...
class App {
  ...
  _newWorkout(e) {
    ...
    let workout;
    // activity is running create running other wise cycling
    if (type === 'running') {
